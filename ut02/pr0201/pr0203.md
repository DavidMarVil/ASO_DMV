...
Una vez modificado el fichero para aplicarlo tenemos q usar el comando 
````
  ...
  ethernets:
    ...
    enp0s8:
      addresses:
        - 192.168.20.11/24
````
### Nos conectamos por ssh a los servidores b y c



````
david@dmvssh:~$ ssh sysadmin@192.168.30.11
The authenticity of host '192.168.30.11 (192.168.30.11)' can't be established.
ED25519 key fingerprint is SHA256:EIoHBLBqhsKXcylzo78fJ7gBRyuB70IgBO9AtfJytOA.
